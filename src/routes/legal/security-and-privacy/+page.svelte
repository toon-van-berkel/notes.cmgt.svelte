...
<main>
    <div class="breadcrumbs">
        <a href={base + "/"}>Home</a> / <a href={base + "/legal"}>Legal</a> / <a href={base + "/legal/security-and-privacy"}>Security & Privacy</a>
    </div>
    ...
    <section id="publicMedia">
        ...
        <ul>
            <li>Already publicly available online on other websites or platforms, or</li>
            <li>Provided under terms that allow public use and display.</li>
        </ul>
    ...
    <section id="collection">
        ...
        <ul>
            ...
            <li>No personal identifiers (such as names, email addresses, or IP addresses) are stored.</li>
            <li>No analytics tools or tracking cookies are used that would identify individual users.</li>
        </ul>
    </section>
